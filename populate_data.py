...
# ── PLASTIC ──
plastic = Category.objects.create(
    name='plastic',
    description='Plastic waste includes bottles, containers and packaging materials that can be recycled.',
    sorting_guide='1. Rinse all plastic bottles before sorting\n2. Flatten bottles to save space\n3. Remove all caps and lids\n4. Separate plastic from other waste\n5. Place in your recyclables bag',
    tips='Avoid pure water sachets, styrofoam and plastic bags — contamination causes batch rejection.'
)
...
# ── GLASS ──
glass = Category.objects.create(
    name='glass',
    description='Glass waste includes bottles and jars that can be recycled. Safety is the top priority.',
    sorting_guide='1. Only accept whole glass food and drink bottles\n2. Never crush or break glass intentionally\n3. If glass breaks, wrap carefully in newspaper\n4. Place wrapped broken glass in a clearly labelled bag\n5. Verbally warn the collector about broken glass',
    tips='Safety first — broken glass causes severe injuries. Always handle with care and warn collectors.'
)
...
# ── METAL ──
metal = Category.objects.create(
    name='metal',
    description='Metal waste includes aluminium cans and tin or steel cans requiring different handling.',
    sorting_guide='1. Separate aluminium cans from tin and steel cans\n2. Aluminium cans can be gently crushed\n3. Do NOT crush tin or steel cans — dangerous sharp edges\n4. Never include aerosol cans\n5. Never include batteries — hazardous e-waste',
...
# ── PAPER ──
paper = Category.objects.create(
    name='paper',
    description='Paper and cardboard must be kept dry. Moisture is the leading cause of paper batch rejection.',
    sorting_guide='1. Ensure all paper and cardboard is completely dry\n2. Keep paper elevated off the ground\n3. Do not include wax-coated juice cartons or Tetra Paks\n4. Do not include greasy food wrappers\n5. Flatten cardboard boxes to save space',
    tips='Moisture is the number one enemy of paper recycling. Even slightly wet paper can cause batch rejection.'
)
...
# ── ORGANIC ──
organic = Category.objects.create(
    name='organic',
    description='Organic waste includes food scraps and biodegradable materials. Proper separation protects recyclables.',
    sorting_guide='1. Use the Three-Bag Separation System: Recyclables, Organic, General waste\n2. Never mix food scraps with recyclables\n3. Food residue ruins recyclable batches\n4. For composting use a repurposed bucket with holes\n5. Note: Organic pickups not yet available — compost at home',
    tips='The Three-Bag Separation System is the foundation of Ecosort. Keep organic waste separate always.'
)
...
# ── EWASTE ──
ewaste = Category.objects.create(
    name='ewaste',
    description='Electronic waste includes old phones, cables, batteries and electrical devices containing toxic materials.',
    sorting_guide='1. NEVER BURN E-WASTE — most critical rule\n2. Identify e-waste: phones, cables, batteries, chargers, laptops\n3. Store e-waste separately from all other waste\n4. Text EWASTE to our WhatsApp bot for local drop-off points\n5. Never throw e-waste in general waste bins',
    tips='Burning e-waste releases toxic lead, mercury and arsenic — causing serious health risks to your community.'
)
...
print("✅ All 6 categories and 30 quiz questions added successfully!")